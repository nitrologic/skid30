...
#define MODE_OLDFILE	     1005   /* Open existing file read/write positioned at beginning of file. */
#define MODE_NEWFILE	     1006   /* Open freshly created file (delete old file) read/write, exclusive lock. */
#define MODE_READWRITE	     1004   /* Open old file w/shared lock, creates file if doesn't exist. */
